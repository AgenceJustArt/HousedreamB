...
<div class="eleven columns">
				<div id="article">
					<h1 class="blue">Liens web - <?php echo $data['title']; ?></h1>
					<?php 
...
<div class="five columns">
				<div id="search-doc">
                    ...
                    <div class="round bg-blue">1</div><h3 class="blue">Les catégories de liens :</h3>
					<?php
						...
						$v = current($v);
						 ...
						 echo $this->Html->link(
						'<div id="filter">'.$v['name'].'<p class="blue">'.$v['content'].'</p><span class="arrow-blue"></span></div>',
						array('controller'=>'ressource','action'=>'liens',$v['id']),

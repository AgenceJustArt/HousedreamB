 ...
 <?php $this->set('title_for_layout','Pays d\'Argonne - Les lieux ressources d\'associations Argonnaises'); ?>
...
<div class="eleven columns">
				<div id="article">
					...
					<div id="articleItem">
						...
						<?php echo $this->Html->link('Voir le lieux',array('controller'=>'ressource','action'=>'lieuxdetail','slug'=>$v['slug'],'id'=>$v['id']),array('class'=>'blue')); ?> - Ajouté le <?php echo $v['created']; ?>
					</div>
					<?php endforeach ?> 

...
<div class="eleven columns">
				<div id="article">
					<h1 class="pink">Associations - <?php echo ucfirst($location); ?></h1>
					<?php 
...
<div class="five columns">
				<div id="search-asso">
					...
					<div id="zone">
						...
						echo $this->Html->link('',array('controller'=>'association','action'=>'zone','location'=>strtolower($zone[0])),array('class'=>'ardenne','escape'=>false));
						echo $this->Html->link('',array('controller'=>'association','action'=>'zone','location'=>strtolower($zone[1])),array('class'=>'marne','escape'=>false));
